            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center pt-3 pb-3">
                        <span class="db"><img src="../admin/assets/images/logo.png" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="ten" class="form-control form-control-lg" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" />
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-warning text-white h-100" id="basic-addon2"><i class="mdi mdi-lock fs-4"></i></span>
                                    </div>
                                    <input type="password" name="matkhau" class="form-control form-control-lg" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="pt-3">
                                        ...
                                        <input class="btn btn-success float-end text-white" type="submit" name="dangnhap" value="Login">
                                    </div>
                                </div>
                            </div>
                        </div>
